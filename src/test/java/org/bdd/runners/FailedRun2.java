...
@CucumberOptions(plugin = {"pretty", "html:target/cucumber-reports/cucumber-pretty",
        ...
        "rerun:rerun/cucumber-reports/rerun2.txt"},
        features = {"@rerun/cucumber-reports/rerun2.txt"},
        glue = {"org.bdd.stepdef"},
        dryRun = false, monochrome = true

)
public class FailedRun2 {
    ...
    public void setUp(String deviceName) {
        ...
        ExtentReporter.initializeExtentReports(reportPath);
