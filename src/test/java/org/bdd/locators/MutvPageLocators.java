...
public class MutvPageLocators {
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/txtHeaderTitle")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"MY LIST\"]")
	public WebElement myListTextMutvScreen;

	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/podcast_library_add")
	@iOSXCUITFindBy(accessibility = "Add Tracks to Library")
	public WebElement plusIconMutvScreen;

	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/library_desc_text_view")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/podcast_library_download")
...
//	public WebElement plusIconInMyListScreen;
	...
	@AndroidFindBy(xpath = "(//android.widget.ImageView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/card_image\"])[1]")
	...
	@AndroidFindBy(xpath = "//android.widget.ImageView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/podcast_player_cover_image\"]")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/podcast_player_cover_image")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/podcast_mylist_icon")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeCollectionView/XCUIElementTypeCell[3]/XCUIElementTypeOther[2]/XCUIElementTypeStaticText/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[1]/XCUIElementTypeButton")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/podcast_mylibrary_right_arrow")
	@iOSXCUITFindBy(accessibility = "Back")
	public WebElement greaterThenSymbolInMyListScreen;

	@AndroidFindBy(accessibility = "Close")
	public WebElement closeButton;
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/parentLayout")
	public List<WebElement> videosMutvPage;
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/header")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/epg_time")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/epg_playing_now")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"PLAYING NOW\"]")
	public WebElement playNowTextSchedulePage;
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/epg_title_icon")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/epg_title")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/epg_play")
...
//	@iOSXCUITFindBy(xpath = "//XCUIElementTypeCollectionView[2]/XCUIElementTypeCell/XCUIElementTypeOther")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/podcast_control_close")
	@iOSXCUITFindBy(accessibility = "xCircleFill")
	public WebElement closeButtonVideo;
	@AndroidFindBy(xpath = "(//android.widget.ImageView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/epg_play\"])[3]")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/btn_epg_reminder_ok")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/current_time")
	public WebElement currentPlayTimeVideoMutvPage;
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/end_time")
	...
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/btn_epg_reminder_close")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name=\"CLOSE\"]")
	public WebElement closeIconMutvSchedulePage;
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/podcast_shows_listen_btn")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name=\"CLOSE\"]")
	...
	@AndroidFindBy(xpath = "(//android.widget.LinearLayout[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/parentLayout\"])[7]")
	...
	@AndroidFindBy(xpath = "//android.widget.FrameLayout[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/frame\"]/android.widget.LinearLayout")
	...
	@AndroidFindBy(xpath = "(//android.widget.ImageView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/podcast_viewall_img\"])[2]")
	...
	@AndroidFindBy(xpath = "(//android.widget.TextView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/epg_playing_now\"])[1]")
	public WebElement cbsBadgeInSchedulePage;
	@AndroidFindBy(xpath = "com.mu.muclubapp.preprod_mu_dxc:id/text_mutv")
	public WebElement mutvIconInSetReminderSchedule;
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/epg_shedule_time\"]")
	public WebElement showingTimeInSetReminderSchedule;
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/epg_shedule_reminder_desc\"]")
	public WebElement descSetReminderSchedule;
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/btn_epg_reminder_ok\"]")
	public WebElement setReminderButtonInSchedulePage;
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/btn_epg_reminder_close\"]")
	public WebElement closeButtonInSchedulePage;
	
	@AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/tv_title")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"Full 90: United v Fulham\"]")
	public WebElement podcastTextInMUTV;
	
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/podcast_viewall_title\"]")
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/library_desc_text_view\"]")
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"com.mu.muclubapp.preprod_mu_dxc:id/podcast_library_download\"]")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"FIND SOMETHING TO ADD\"]")
