...
public class OnboardingPageLocators {
	 ...
	 @AndroidFindBy(className = "email")
	    ...
	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/tv_onboarding_welcome_header')]")
	    @iOSXCUITFindBy(accessibility = "WELCOME TO THE MAN UTD APP")
	    public WebElement welcomeToTheManUtdApp;

	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/tv_onboarding_bottom_title')]")
	    @iOSXCUITFindBy(accessibility = "FOOTBALL IS NOTHING WITHOUT FANS")
	    public WebElement quoteScreen1;

	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/tv_onboarding_bottom_desc')]")
	...
	//screen 2 all locators(welcome screen)
	    ...
	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/ask_me_later_btn')]")
	    @iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name=\"ASK ME LATER\"]")
	    public WebElement askMeLaterScreen2;

	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/bottom_button')]")
	    @iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name=\"ALLOW\"]")
	    public WebElement allowBtnScreen2;

	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/permission_message')]")
	    ...
	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/tv_onboarding_fav_player_header')]")
	    ...
	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/onboarding_login_header')]")
	    @iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name=\"SIGN FOR UNITED\"])[1]")
	    public WebElement welcomeTextScreen4;

	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/signup_screen_text') and @text='FULL MUTV ACCESS']")
	    @iOSXCUITFindBy(accessibility = "Full MUTV Access")
	    public WebElement fullMutvAccessScreen4;

	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/signup_screen_text') and @text='UNITED PREDICTIONS']")
	    @iOSXCUITFindBy(accessibility = "UNITED PREDICTIONS")
	    public WebElement unitedPredictionsScreen4;

	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/signup_screen_text') and @text='OFFERS & REWARDS']")
	    @iOSXCUITFindBy(accessibility = "OFFERS & REWARDS")
	    public WebElement offersAndRewardsScreen4;

	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/united_textview')]")
	    @iOSXCUITFindBy(accessibility = "GET EXCLUSIVE ACCESS")
	    public WebElement getExclisiveScreen4;

	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/tv_desc')]")
	    ...
	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/parentLayout')]")
	    ...
	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/back_to_top')]")
	    ...
	    @AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, ':id/signup_screen_text')]")
