...
public class UnitedNowPageLocators {
    ...
    @AndroidFindBy(id = "com.mu.muclubapp.preprod_mu_dxc:id/mDateTxt")
    ...
    @AndroidFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"Erik ten Hag will hold his pre-match press conference upon arrival in Portugal on Wednesday evening. Get the latest news and then watch it on-demand from 19:00 BST.\"]")
    @iOSXCUITFindBy(xpath = "//android.widget.TextView[@content-desc=\"saysErik ten Hag will hold his pre-match press conference upon arrival in Portugal on Wednesday evening. Get the latest news and then watch it on-demand from 19:00 BST. double tap to activate\"]")
