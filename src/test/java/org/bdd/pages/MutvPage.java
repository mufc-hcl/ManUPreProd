...
//				 ExtentsReportManager.extentReportLogging("pass","Clicks on viewProgramsPopUp ");
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clickOnMutvTab()<br />" + e);
            throw e;
        }
    }
    ...
    public void clickOnMyListIcon() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clickOnMyListIcon()<br />" + e);
            throw e;
    ...
    public String getMyListTitleMyListPage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-getMyListTitleMyListPage()<br />" + e);
            throw e;
        }
    }
    ...
    public String getDescriptionMyListPage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-getDescriptionMyListPage()<br />" + e);
            throw e;
        }
    }
    ...
    public String getAddButtonMylistPage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-getAddButtonMylistPage()<br />" + e);
            throw e;
        }
    }
    ...
    public Boolean checkBackButtonDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-checkBackButtonDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public Boolean checkPlusIconDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-checkPlusIconDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public void clickScheduleIconMutvScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clickScheduleIconMutvScreen()<br />" + e);
            throw e;
...
//            waitForVisibilityFluentWait(mutvPageLocators.backIconSheduleScreenMutv);
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clickOnBackIconScheduleMutvScreen()<br />" + e);
            throw e;
...
//                elementToBeClickableFluentWait(mutvPageLocators.notNowButtonMatchAppearanceAlert);
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clickOnNotNowButtonInMatchAppearanceAlertScreen()<br />" + e);
            throw e;
        }
    ...
    public void selectsTheDontAllowButtonInAudioNotificationAlert() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-selectsTheDontAllowButtonInAudioNotificationAlert()<br />" + e);
            throw e;
    ...
    public void selectsNotAllowInThePhotosAndVideosAccessInAlert() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-selectsNotAllowInThePhotosAndVideosAccessInAlert()<br />" + e);
            throw e;
    ...
    public void clicksOnTheNotificationAtBottomOfScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnTheNotificationAtBottomOfScreen()<br />" + e);
            throw e;
    ...
    public void clicksOnPlusIcon() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnPlusIcon()<br />" + e);
            throw e;
...
//                IosGenericLibrary.scroll(driver, null, IosGenericLibrary.ScrollDirection.DOWN, 0.7);
    ...
    public void clickPlusSymbolMyListScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clickPlusSymbolMyListScreen()<br />" + e);
            throw e;
    ...
    public void clicksOnUncheckMylistIcon() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnUncheckMylistIcon()<br />" + e);
            throw e;
    ...
    public void ClickOnLessThanSymbolButtonInMyListScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ClickOnLessThanSymbolButtonInMyListScreen()<br />" + e);
            throw e;
    ...
    public void clickOnGreaterThenSymbolInMyListScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clickOnGreaterThenSymbolInMyListScreen()<br />" + e);
            throw e;
    ...
    public boolean validateplusIconIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validateplusIconIsDisplayed()<br />" + e);
            throw e;
        }
    }
...
//                } 
    ...
    public boolean validateSubscribeScreenIsDisplayed() {
        try {
            if (mutvPageLocators.headerCBRCBSPage.isDisplayed() && mutvPageLocators.headerCBRCBSPage.getText().equalsIgnoreCase("SUBSCRIBE"))
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validateSubscribeScreenIsDisplayed()<br />" + e);
            throw e;
        }
    }
...
//                } 
    ...
    public boolean validateRegisterScreenIsDisplayed() {
        try {
            if (mutvPageLocators.headerCBRCBSPage.isDisplayed() && mutvPageLocators.headerCBRCBSPage.getText().equalsIgnoreCase("SIGN UP"))
                ExtentsReportManager.extentReportLogging("pass", "Returns headerCBRCBSPage Text");
            return mutvPageLocators.headerCBRCBSPage.isDisplayed();
        } catch (Exception e) {
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validateRegisterScreenIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validateTimeInScheduleScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validateTimeInScheduleScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validateVideoIconInScheduleScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validateVideoIconInScheduleScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatePlayingNowTextInScheduleScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatePlayingNowTextInScheduleScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validateVideoTitleInScheduleScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validateVideoTitleInScheduleScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatePlayButtonInScheduleScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatePlayButtonInScheduleScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnPlayButtonInScheduleScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnPlayButtonInScheduleScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnCloseButton() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnCloseButton()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnPlusIconInMutvScheduleScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnPlusIconInMutvScheduleScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnGoToSettings() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnGoToSettings()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnNotificationFromAppInfoScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnNotificationFromAppInfoScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnSetRemainderIcon() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnSetRemainderIcon()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnManUtdStageInAlarmAndReminder() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnManUtdStageInAlarmAndReminder()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnAlarmSwitchInAlarmAndRemainder() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnAlarmSwitchInAlarmAndRemainder()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnRemainderSetIcon() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnRemainderSetIcon()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validateTheTickIconDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validateTheTickIconDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public void clickOnAVideoInMutvPage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clickOnAVideoInMutvPage()<br />" + e);
            throw e;
        }
    }
    ...
    public String obtainedTheCurrentVideoTime() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-obtainedTheCurrentVideoTime()<br />" + e);
            throw e;
        }
    ...
    public void playsTheVideoForTwentySeconds() throws Exception {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-playsTheVideoForTwentySeconds()<br />" + e);
            throw e;
        }
    }
    ...
    public String obtainedTheTotalVideoTime() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-obtainedTheTotalVideoTime()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnTheTickIconInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnTheTickIconInIos()<br />" + e);
            throw e;
        }
    ...
    public boolean validateTheTickIconDisplayedInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validateTheTickIconDisplayedInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnRemainderSetIconInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnRemainderSetIconInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validateCloseIconIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validateCloseIconIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksInCloseIconInRemainderSetPage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksInCloseIconInRemainderSetPage()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksPlayButtonInThePodcastScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksPlayButtonInThePodcastScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean verifyPlayButtonForTheSubscribedUser() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-verifyPlayButtonForTheSubscribedUser()<br />" + e);
            throw e;
        }
    }
...
//			}
    ...
    public String getSubscrptionTitleSubcribePage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-getSubscrptionTitleSubcribePage()<br />" + e);
            throw e;
        }
    }
    ...
    public String getDescriptionSubscribePage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-getDescriptionSubscribePage()<br />" + e);
            throw e;
        }
    }
    ...
    public void ClicksOnLoginButtonInSubscribeScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ClicksOnLoginButtonInSubscribeScreen()<br />" + e);
            throw e;
        }
    ...
    public void ClicksOnPlayIconForCBSVideo() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ClicksOnPlayIconForCBSVideo()<br />" + e);
            throw e;
        }
...
//			AndroidGenericLibrary.switchToNativeViewIos(((IOSDriver) driver));
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnLoginButtonInSubscribeScreenInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public void selectsTheVideoAndCheckCBRBadgeInIos() throws InterruptedException {
        try {
            ...
            while (i > 0) {
//                String type = "name";
                List<WebElement> e = driver.findElements(AppiumBy.xpath("(//XCUIElementTypeStaticText[@name=\"  Register to watch\"])"));
                if (e.size() > 0) {
                    ...
                    i++;
                    if(i>30){
                        ExtentsReportManager.extentReportLogging("fail", "Failing due to excesive scroll and unable to find the cbr video " + e);
                        break;
                    }
                }
            }
...
//            }
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnImagePopUpWindow()<br />" + e);
            throw e;
        }
    ...
    public String getSignUpTitleRegisterPage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-getSignUpTitleRegisterPage()<br />" + e);
            throw e;
        }
    }
    ...
    public String getDescSignUpTitleRegisterPage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-getDescSignUpTitleRegisterPage()<br />" + e);
            throw e;
        }
    }
...
//            mutvPageLocators.playIconCBRVideoScreen.click();
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnPlayIconForCBRVideo()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnViewAllMutvPage() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occurred in function-scrollsDownToMyUnitedAllPointsSeasonCard()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean MutvTabInTheNavigationBarIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-MutvTabInTheNavigationBarIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean ValidatesTheSearchIconInMutvIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ValidatesTheSearchIconInMutvIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean ValidatesScheduleIconIsDisplayedInMUTVScreenInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ValidatesScheduleIconIsDisplayedInMUTVScreenInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean ValidatesMyListIconIsDisplayedInTheMUTVScreenInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ValidatesMyListIconIsDisplayedInTheMUTVScreenInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean ValidatesHeroContainerIsDisplayedInMUTVIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ValidatesHeroContainerIsDisplayedInMUTVIos()<br />" + e);
            throw e;
        }
    }
...
//	            IosGenericLibrary.scroll(driver, null, IosGenericLibrary.ScrollDirection.DOWN, 0.7);
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ValidatesEpisodeCarouselsAreDisplayedIos()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean ValidatesViewAllButtonIsDisplayedForEpisodeCarouselsInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ValidatesViewAllButtonIsDisplayedForEpisodeCarouselsInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean ValidatesEpisodeLandingScreenInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ValidatesEpisodeLandingScreenInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnPlayIconInVideoLandingScreenInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnPlayIconInVideoLandingScreenInIos()<br />" + e);
            throw e;
        }
    ...
    public void clicksOnFullEpisodeTypeVideosInVideoLandingScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnFullEpisodeTypeVideosInVideoLandingScreen()<br />" + e);
            throw e;
        }
    ...
    public boolean ValidatesFullEpisodeLandingScreenInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ValidatesFullEpisodeLandingScreenInIos()<br />" + e);
            throw e;
        }
    }
...
//			 IosGenericLibrary.scroll(driver, null, IosGenericLibrary.ScrollDirection.DOWN, 0.7);
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnViewAllMutvPageInIos()<br />" + e);
            throw e;
        }
    ...
    public boolean ValidatesClipTypeVideoPlaysTheVideosInFullScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-ValidatesClipTypeVideoPlaysTheVideosInFullScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesPlusIconIsDisplayedInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesPlusIconIsDisplayedInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnPlusIconInPodcastAudioScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnPlusIconInPodcastAudioScreen()<br />" + e);
            throw e;
        }
    ...
    public boolean validatesTheCBRVideoInMyListScreenInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesTheCBRVideoInMyListScreenInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesTheCBSVideoInMyListScreenInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesTheCBSVideoInMyListScreenInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnOnePodcastAudioInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnOnePodcastAudioInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnCBRVideoIconInMylistScreenInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnCBRVideoIconInMylistScreenInIos()<br />" + e);
            throw e;
        }
    ...
    public void clicksOnCBSVideoIconInMylistScreenInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnCBSVideoIconInMylistScreenInIos()<br />" + e);
            throw e;
        }
    ...
    public boolean validatesPodcastAudioInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesPodcastAudioInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesTheMutvTabInTheNavigationBar() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesTheMutvTabInTheNavigationBar()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesTheSearchOptionInMutvScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesTheSearchOptionInMutvScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesScheduleIconDisplayedInMutvScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesScheduleIconDisplayedInMutvScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesHeroContainerIsDisplayedInMutvWhenEnabledFromCMS() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesHeroContainerIsDisplayedInMutvWhenEnabledFromCMS()<br />" + e);
            throw e;
        }
    }
    ...
    public List<Boolean> validatesEpisodeCarouselsAreDisplayedInMutvScreen() {
        ...
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesEpisodeCarouselsAreDisplayedInMutvScreen()<br />" + e);
            throw e;
        }
        return flag;
    }
    ...
    public boolean navigatesToOneOfTheEpidsodeCaroselAndValidatesTheViewAllButton() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-navigatesToOneOfTheEpidsodeCaroselAndValidatesTheViewAllButton()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean tapsAndVerifyEpisodeLandingScreenIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-tapsAndVerifyEpisodeLandingScreenIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean tapsFullEpisodeTypeVideosAndVerifyVideoLandingPageIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-tapsFullEpisodeTypeVideosAndVerifyVideoLandingPageIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean tapsClipAndVideoPlaysInFullScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-tapsClipAndVideoPlaysInFullScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesMyListIconIsDisplayedInTopLeftOfMutvScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesMyListIconIsDisplayedInTopLeftOfMutvScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesMyListScreenIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesMyListScreenIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean tapsBackIconAndValidateMutvPageIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-tapsBackIconAndValidateMutvPageIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean userValidatesFindSomethingToAddButtonIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-userValidatesFindSomethingToAddButtonIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesPlusIconIsDisplayed() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesPlusIconIsDisplayed()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnLogInButtonForCBRVideo() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnLogInButtonForCBRVideo()<br />" + e);
            throw e;
        }
    ...
    public boolean validatesHeroContainerIsDisplayedInMutvWhenEnabledFromCMSinios() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatesHeroContainerIsDisplayedInMutvWhenEnabledFromCMSinios()<br />" + e);
            throw e;
        }
    }
    ...
    public void clicksOnOnePodcastAudioInMutvScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-clicksOnOnePodcastAudioInMutvScreen()<br />" + e);
            throw e;
    ...
    public boolean validatePodcastAudioInMyListScreen() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occured in function-validatePodcastAudioInMyListScreen()<br />" + e);
            throw e;
        }
    }
    ...
    public void NavigatesToCBSVideoInIos() {
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occurred in function-navigatesToAppDebutInIos()<br />" + e);
            throw e;
        }
    }
    ...
    public boolean validatesMutvIconAndDescriptionAlongWithProgramDetails() {
        try {
            ...
            return (mutvPageLocators.mutvIconInSetReminderSchedule.isDisplayed() && mutvPageLocators.showingTimeInSetReminderSchedule.isDisplayed() && mutvPageLocators.descSetReminderSchedule.isDisplayed());
        } catch (Exception e) {
    ...
    public boolean validatesSetReminderButtonAndCloseButton() {
        try {
            ...
            return (mutvPageLocators.setReminderButtonInSchedulePage.isDisplayed() && mutvPageLocators.closeButtonInSchedulePage.isDisplayed());
        } catch (Exception e) {
    ...
    public String getPodcastTextFromMUTVScreen() {
        String device = GlobalParams.getPlatformName();
          try {
              ...
              ExtentsReportManager.extentReportLogging("fail", "Exception occurred in function-getPodcastTextFromMUTVScreen()<br />" + e);
              throw e;
          }
    }
...
//				for (int j = 0; j < 3; j++) {
					for (int i = 0; i < size; i++) {
						actualShopMenuItems.add(mutvPageLocators.epgScheduleWeeklyDescription.get(i)
								.getDomAttribute("name").toLowerCase());
					}
					uniqueString.addAll(actualShopMenuItems);
//					IosGenericLibrary.scroll(driver, null, IosGenericLibrary.ScrollDirection.DOWN, 0.92);
//				}
...
//            elementToBeClickableFluentWait(explorePageLocators.searchButtonUnitedPage,5);
            ...
            ExtentsReportManager.extentReportLogging("fail","Exception occured in function-clicksSearchInUnitedScreen()<br />" + e);
            throw e;
        }
    }
	...
	public String getMyListTitle() {
        ...
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occurred in function-getMyListTitle()<br />" + e);
            throw e;
        }
	}
	...
	public String getMyListDesc() {
        ...
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occurred in function-getMyListDesc()<br />" + e);
            throw e;
        }
	}
	...
	public String getFindSomeThingToAdd() {
        ...
        try {
            ...
            ExtentsReportManager.extentReportLogging("fail", "Exception occurred in function-getFindSomeThingToAdd()<br />" + e);
            throw e;
        }
	}
